...
public class MyCalculatorTestMultiplicar {
	...
	public void divide2itensResultadoSomaDosDois() {
		...
		Assert.assertThat(2.3, equalTo(myCalculator.multiply("1,2.39878")));
	}
	...
	@Test
	public void divideSimetriaResultado() {
	...
	public void divideSoma3itensResultadoSomaDosDois() {
		...
		Assert.assertThat(7.7, equalTo(myCalculator.multiply("1,2,3.89778")));
	}
