...
//		
//		String result = Stream.of(""+number.doubleValue()).map(str -> str.replaceAll(",", ".").substring(0, str.indexOf(".") +1)).;
//
//		
//		return Double.valueOf( decimalFormat.format(number.doubleValue()).replaceAll(",", "."));
//	}
//}
